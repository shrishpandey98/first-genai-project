...
from restaurant_reco_phase2.data_access import load_restaurants_parquet
from restaurant_reco_phase2.models import Budget, RecommendationRequest
from restaurant_reco_phase2.recommender import recommend


def main() -> None:
    parser = argparse.ArgumentParser(description="Phase 2 deterministic restaurant recommender (JSON output).")
